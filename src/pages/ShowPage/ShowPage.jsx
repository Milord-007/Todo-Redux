...
console.log(product);
  return (
    <div>
      ...
      >
        <SwiperSlide > <img src={el.images[0]} alt="" className=' '/></SwiperSlide>
        <SwiperSlide> <img src={el.images[1]} alt="" /> </SwiperSlide>
        <SwiperSlide> <img src={el.images[2]} alt="" /> </SwiperSlide>
        <SwiperSlide> <img src={el.images[3]} alt="" /> </SwiperSlide>
        <SwiperSlide> <img src={el.images[4]} alt="" /> </SwiperSlide>
              ...
              <div className='w-[40%] pt-[80px]  '>
               ...
               <button className='bg-[#ffdd00] text-white font-[600] text-[20px] rounded-lg mt-[30px] p-2 w-full'>В корзину</button>
                </div>
              </div>
